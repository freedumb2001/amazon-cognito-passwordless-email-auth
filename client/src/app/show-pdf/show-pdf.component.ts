...
export class ShowPdfComponent {
    ...
    pdfSrc = '';
    pdfLabel = '';
    pdfSrcs = { '1': "https://planungsbuero-schulz.de/wp-content/uploads/2021/09/Expose-1.pdf", '2': "https://planungsbuero-schulz.de/wp-content/uploads/2021/09/Expose-2.pdf" };
